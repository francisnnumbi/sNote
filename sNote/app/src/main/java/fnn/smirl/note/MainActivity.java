...
public class MainActivity extends AppCompatActivity implements OnClickListener {
	...
	public static Memos memos = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sdcard = ctx.getExternalFilesDir(null);
		dir =	new File(sdcard.getAbsolutePath(), "/data");
		res = getResources();
		ACTIVITY = this;
		setupToolbar();
		setupFab();
		...
		filename = dir.getAbsolutePath() + "/snote.json";
...
//
	...
	public static void newMemo(Activity ctxt) {
		Intent intent = new Intent(ctxt, NoteActivity.class);
